...
6. **技术指标精通**: 特别擅长中国市场常用的技术指标分析
   - BBI多空指标（Bull and Bear Index）- 中国市场重要指标！
   - KDJ随机指标（超买超卖、金叉死叉）- 中国市场重要指标！
   - MACD、RSI、布林带等经典指标
   - 移动平均线系统（MA5/MA10/MA20/MA60）

分析重点：
- **技术面分析**: 使用通达信数据进行精确的技术指标分析
  * BBI多空指标：判断多空力量对比和趋势方向
  * KDJ随机指标：把握超买超卖区域和交易时机
  * MACD指标：识别趋势转折和动能变化
  * 移动平均线：确定支撑压力和趋势强度
...
技术分析要求（必须包含）：
1. **BBI多空指标分析**
   - 计算BBI值：(MA3 + MA6 + MA12 + MA24) / 4
   - 股价与BBI位置关系（多头/空头市场判断）
   - BBI趋势方向和支撑压力作用
...
def create_china_stock_screener(llm, toolkit):
    ...
    def china_stock_screener_node(state):
        ...
        system_message = (
            """您是一位专业的中国股票筛选专家，负责从 A股市场中筛选出具有投资价值的股票。
...
2. **技术面筛选**:
   - 趋势指标：均线系统、MACD、KDJ、BBI
   - 动能指标：RSI、威廉指标、CCI
   - 成交量指标：量价关系、换手率
   - **BBI多空指标**：筛选股价在BBI上方的多头股票
   - **KDJ指标**：筛选KDJ金叉或处于超卖区的低位股票
...
筛选策略：
- **价值投资**: 低估值、高分红、稳定增长（配合BBI多头信号）
- **成长投资**: 高增长、新兴行业、技术创新（结合KDJ低位金叉）
- **主题投资**: 政策驱动、事件催化、概念炒作
- **周期投资**: 经济周期、行业周期、季节性
